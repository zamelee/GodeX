...
所有脚本定义在 [package.json:25-44](https://github.com/Ahoo-Wang/GodeX/blob/main/package.json#L25)。

## 交叉引用

- [流式管道](../05-streaming-pipeline/stream-pipeline.md) -- 单元测试的转换器如何组装成响应管道
- [架构概览](../02-architecture/overview.md) -- 被测试模块与系统架构的关系
- [提供商开发](../03-provider-development/provider-development.md) -- 兼容性测试套件如何应用于新提供商
- [会话管理](../04-session-management/session-management.md) -- 会话夹具和多轮测试场景
